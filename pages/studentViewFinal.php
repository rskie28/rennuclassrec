			...
			<?php
				...
				if ($res->num_rows>0) {
					if($row=$res->fetch_assoc()){
						...
						echo "<center><h2><b>Midterm</b></h2></center>";
						...
						$_SESSION['midtermGrade'] = $totalGradePerc;
				...
				//Final Term Grade
				//
				$sqlF = "SELECT * FROM users u, stud_info si, grades g, courses c, gradeperc gc, actdetails ad
						WHERE u.uName = '".$_SESSION['uName']."'
						AND u.id = si.stud_id
						AND si.stud_id = g.stud_id
						AND g.sectionID = '$section'
				...
				if ($resF->num_rows>0) {
					if($row=$resF->fetch_assoc()){
						echo "<br><br><center><h2><b>Final Term</b></h2></center>";
						//echo "<h4>Grading Percentage:</h4>";
						...
						echo "<input type='text' id='midGrade' value='".$totalGradePerc."' hidden>";
						echo "<center>";
							if ($_SESSION['midtermGrade'] <= 69.49) {
								echo "<h1 style='color: red'>Midterm Grade: <b>R</b></h1>";
							} else if ($_SESSION['midtermGrade'] >= 69.50 AND $_SESSION['midtermGrade'] <= 74.49) {
								echo "<h1 style='color: green'>Midterm Grade: <b>1.0</b></h1>";
							} else if ($_SESSION['midtermGrade'] >= 74.50 AND $_SESSION['midtermGrade'] <= 78.49) {
								echo "<h1 style='color: green'>Midterm Grade: <b>1.5</b></h1>";
							} else if ($_SESSION['midtermGrade'] >= 78.50 AND $_SESSION['midtermGrade'] <= 82.49) {
								echo "<h1 style='color: green'>Midterm Grade: <b>2.0</b></h1>";
							} else if ($_SESSION['midtermGrade'] >= 82.50 AND $_SESSION['midtermGrade'] <= 86.49) {
								echo "<h1 style='color: green'>Midterm Grade: <b>2.5</b></h1>";
							} else if ($_SESSION['midtermGrade'] >= 86.50 AND $_SESSION['midtermGrade'] <= 90.49) {
								echo "<h1 style='color: green'>Midterm Grade: <b>3.0</b></h1>";
							} else if ($_SESSION['midtermGrade'] >= 90.50 AND $_SESSION['midtermGrade'] <= 94.49) {
								echo "<h1 style='color: green'>Midterm Grade: <b>3.5</b></h1>";
							} else if ($_SESSION['midtermGrade'] >= 94.50 AND $_SESSION['midtermGrade'] <= 100) {
								echo "<h1 style='color: green'>Midterm Grade: <b>4.0</b></h1>";
							}
						echo "</center>";
						echo "<center>";
							if (round($totalGradePerc,2) <= 69.49) {
								echo "<h1 style='color: red'>Final Term Grade: <b>R</b></h1>";
							} else if ($totalGradePerc >= 69.50 AND $totalGradePerc <= 74.49) {
								echo "<h1 style='color: green'>Final Term Grade: <b>1.0</b></h1>";
							} else if ($totalGradePerc >= 74.50 AND $totalGradePerc <= 78.49) {
								echo "<h1 style='color: green'>Final Term Grade: <b>1.5</b></h1>";
							} else if ($totalGradePerc >= 78.50 AND $totalGradePerc <= 82.49) {
								echo "<h1 style='color: green'>Final Term Grade: <b>2.0</b></h1>";
							} else if ($totalGradePerc >= 82.50 AND $totalGradePerc <= 86.49) {
								echo "<h1 style='color: green'>Final Term Grade: <b>2.5</b></h1>";
							} else if ($totalGradePerc >= 86.50 AND $totalGradePerc <= 90.49) {
								echo "<h1 style='color: green'>Final Term Grade: <b>3.0</b></h1>";
							} else if ($totalGradePerc >= 90.50 AND $totalGradePerc <= 94.49) {
								echo "<h1 style='color: green'>Final Term Grade: <b>3.5</b></h1>";
							} else if ($totalGradePerc >= 94.50 AND $totalGradePerc <= 100) {
								echo "<h1 style='color: green'>Final Term Grade: <b>4.0</b></h1>";
							}
						echo "</center>";

						if (substr($section,0,7) == "INTCOMC") {
							$subjGrade = ($_SESSION['midtermGrade']*0.4) + ($totalGradePerc*0.6);
						} else {
							$subjGrade = ($_SESSION['midtermGrade'] + $totalGradePerc) / 2;
						}
						echo "<center>";
							if ($subjGrade <= 69.49) {
								echo "<h1 style='color: red'>Subject Grade: <b>R or ".sprintf('%.2f', $subjGrade)."</b></h1>";
							} else if ($subjGrade >= 69.50 AND $subjGrade <= 74.49) {
								echo "<h1 style='color: green'>Subject Grade: <b>1.0 or ".sprintf('%.2f', $subjGrade)."</b></h1>";
							} else if ($subjGrade >= 74.50 AND $subjGrade <= 78.49) {
								echo "<h1 style='color: green'>Subject Grade: <b>1.5 or ".sprintf('%.2f', $subjGrade)."</b></h1>";
							} else if ($subjGrade >= 78.50 AND $subjGrade <= 82.49) {
								echo "<h1 style='color: green'>Subject Grade: <b>2.0 or ".sprintf('%.2f', $subjGrade)."</b></h1>";
							} else if ($subjGrade >= 82.50 AND $subjGrade <= 86.49) {
								echo "<h1 style='color: green'>Subject Grade: <b>2.5 or ".sprintf('%.2f', $subjGrade)."</b></h1>";
							} else if ($subjGrade >= 86.50 AND $subjGrade <= 90.49) {
								echo "<h1 style='color: green'>Subject Grade: <b>3.0 or ".sprintf('%.2f', $subjGrade)."</b></h1>";
							} else if ($subjGrade >= 90.50 AND $subjGrade <= 94.49) {
								echo "<h1 style='color: green'>Subject Grade: <b>3.5 or ".sprintf('%.2f', $subjGrade)."</b></h1>";
							} else if ($subjGrade >= 94.50 AND $subjGrade <= 100) {
								echo "<h1 style='color: green'>Subject Grade: <b>4.0 or ".sprintf('%.2f', $subjGrade)."</b></h1>";
							}
						echo "</center>";
					}	
				}
...
<!--<script>
	function myFunc() {
		...
		if (sg == "1.0") {
  		...
  		if (ftg <=100) {
	  		if (ftg < 69.5) {
	  			dispMsg = fixedMsg.concat("R or ",ftg," to be specific.");
	  		} else if (ftg > 69.4 && ftg < 74.5) {
	  			dispMsg = fixedMsg.concat("1.0 or ",ftg," to be specific.");
	  		} else if (ftg > 74.4 && ftg < 78.5) {
	  			dispMsg = fixedMsg.concat("1.5 or ",ftg," to be specific.");
	  		} else if (ftg > 78.4 && ftg < 82.5) {
	  			dispMsg = fixedMsg.concat("2.0 or ",ftg," to be specific.");
	  		} else if (ftg > 82.4 && ftg < 86.5) {
	  			dispMsg = fixedMsg.concat("2.5 or ",ftg," to be specific.");
	  		}  else if (ftg > 86.4 && ftg < 90.5) {
	  			dispMsg = fixedMsg.concat("2.5 or ",ftg," to be specific.");
	  		} else if (ftg > 90.4 && ftg < 94.5) {
	  			dispMsg = fixedMsg.concat("2.5 or ",ftg," to be specific.");
	  		} else if (ftg > 94.4 && ftg <= 100) {
	  			dispMsg = fixedMsg.concat("2.5 or ",ftg," to be specific.");
	  		}
	  	} else {
